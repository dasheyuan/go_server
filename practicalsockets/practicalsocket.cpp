...
void UDPSocket::setBroadcast() {
    ...
    setsockopt(sockDesc, SOL_SOCKET, SO_RCVBUF, (char *) &optVal, static_cast<socklen_t>(optLen));
    optVal = 0;
    getsockopt(sockDesc, SOL_SOCKET, SO_RCVBUF, (char *) &optVal, reinterpret_cast<socklen_t *>(&optLen));
    printf("sockDesc, recv buf is %d\n", optVal);
}
